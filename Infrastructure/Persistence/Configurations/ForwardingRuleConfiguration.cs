...
namespace Infrastructure.Persistence.Configurations
{
    public class ForwardingRuleConfiguration : IEntityTypeConfiguration<ForwardingRule>
    {
        ...
        public void Configure(EntityTypeBuilder<ForwardingRule> builder)
        {
            ...
            _ = builder.Property(fr => fr.RuleName).IsRequired().HasMaxLength(100);
            _ = builder.Property(fr => fr.IsEnabled).IsRequired().HasDefaultValue(true);
            _ = builder.Property(fr => fr.SourceChannelId).IsRequired();
            ...
            _ = builder.OwnsOne(fr => fr.EditOptions, editOptionsBuilder =>
            {
                // ... (This part was correct and remains the same) ...
                _ = editOptionsBuilder.OwnsMany(e => e.TextReplacements, replacementBuilder =>
                {
                    _ = replacementBuilder.ToTable("ForwardingRuleTextReplacements");
                    _ = replacementBuilder.WithOwner().HasForeignKey("ForwardingRuleName");
                    _ = replacementBuilder.Property<int>("Id").ValueGeneratedOnAdd();
                    _ = replacementBuilder.HasKey("Id");
                    _ = replacementBuilder.Property(t => t.Find).IsRequired();
                });
            });

            // Configure MessageFilterOptions as an owned entity.
            _ = builder.OwnsOne(fr => fr.FilterOptions, filterOptionsBuilder =>
            {
